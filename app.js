...
function showOnly(id){
  ['#menu-view','#report-view','#progress-view','#admin-view'].forEach(x=>$(x).classList.toggle('hidden',x!==id));
...
function searchStudent(){
  ...
  if(!found.length){
    ...
    ['#menu-view','#report-view','#progress-view','#admin-view'].forEach(x=>$(x).classList.add('hidden'));
    return;
  }
