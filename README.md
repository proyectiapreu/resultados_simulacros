...
Los nombres de los temas deben mantenerse consistentes entre pruebas para conservar una clasificación temática coherente.
...
## Ajustes de interfaz v5

La interfaz usa la palabra “prueba” para la comunicación con estudiantes, incorpora temas para estudiar primero dentro de la progresión por área, y añade acceso al histórico de puntajes UNAL de Proyectia. La columna técnica `evaluacion` se conserva en los Excel para mantener compatibilidad con la estructura de datos existente.


## Ajustes de interfaz v6

La interfaz está optimizada para escritorio y celular. Las gráficas se recalculan según el ancho disponible y las tablas cambian a tarjetas apiladas en pantallas pequeñas. En la progresión por área, la gráfica aparece primero, seguida por los puntajes de cada prueba y una lista simple de temas recomendados para estudiar. El acceso al histórico de puntajes UNAL se presenta junto al puntaje más reciente.


## Acceso administrativo

Al ingresar `PROYECTIA` en el campo de documento se abre un panel administrativo que reúne todos los estudiantes presentes en `data0` a `data4`, muestra sus puntajes globales por prueba y permite abrir el reporte individual de cada estudiante. Este acceso funciona como una vista de administración dentro del sitio estático.


## Vista por áreas para profesores

Al ingresar `area` en el campo de documento se abre la vista de análisis por áreas. La palabra funciona sin distinguir mayúsculas y minúsculas.

La vista permite:

- seleccionar una prueba con resultados reales cargados;
- escoger entre las cinco áreas;
- consultar el puntaje promedio del área;
- revisar el porcentaje general de acierto;
- identificar los temas con mayor porcentaje de acierto y los temas que requieren mayor revisión;
- revisar el porcentaje de acierto de cada pregunta junto con su respuesta correcta;
- ver Física, Química y Biología por separado dentro de Ciencias naturales.

El perfil `1234` se excluye de todos los cálculos colectivos de esta vista. Las pruebas que todavía no tienen estudiantes reales aparecen deshabilitadas.
